...
│   │
│   ├── layouts/
│   │   └── Layout.astro          # マスターレイアウト (1,190行) ⚠️ 巨大
│   │
│   ├── lib/
...
1. [x] 画像のWebP化
   ...
   - 未使用の `genki_festa_logo.png`, `top_logo.png` を削除
   - publicディレクトリ: 13MB → 12MB に削減
2. [ ] OGP画像の最適化 (681KB - SNS用のため保留)
3. [ ] バンドルサイズ削減

### Phase 4: 長期改善
1. [ ] スタイリング手法の統一（CSS Modules推奨）
2. [ ] テストの追加
3. [ ] ドキュメントの整備
